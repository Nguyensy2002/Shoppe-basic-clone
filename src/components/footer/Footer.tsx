    ...
    return (
        <footer className="py-16 bg-neutral-100">
            <div className="container">
                <div className="grid grid-cols-1 lg:grid-cols-3 grap-4">
                    <div className="lg:col-span-1">
                        <div>© 2023 Shopee. Tất cả các quyền được bảo lưu.</div>
                    </div>
                    <div className="lg:col-span-2">Quốc gia & Khu vực:
                        Singapore
                        Indonesia
                        Đài Loan
                        Thái Lan
                ...
                <div className="text-center text-sm mt-10">
                    ...
                    <div className="mt-6">Công ty TNHH Shopee Địa chỉ: Tầng 4-5-6, Tòa nhà Capital Place, số 29 đường Liễu Giai, Phường Ngọc Khánh, Quận Ba Đình, Thành phố Hà Nội, Việt Nam. Tổng đài hỗ trợ: 19001221 - Email: cskh@hotro.shopee.vn</div>
